...
SQL Migration: 00.05.00_01_drop_started_at_column.sql
"""
...
def upgrade():
    """Apply the 00.05.00_01_drop_started_at_column.sql migration."""
    op.execute(get_migration_sql("00.05.00_01_drop_started_at_column.sql"))
